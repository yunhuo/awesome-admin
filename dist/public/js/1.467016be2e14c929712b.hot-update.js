...
/***/ function(module, exports, __webpack_require__) {
	...
	var FirstPageLink = function FirstPageLink(_ref3) {
	  ...
	  return _react2.default.createElement(_FlatButton2.default, { style: flatButtonStyle, icon: _react2.default.createElement(NavigationFirstPage, null), onClick: onClick });
	};

	var PreviousPageLink = function PreviousPageLink(_ref4) {
	  var isActive = _ref4.isActive;
	  var onClick = _ref4.onClick;
	  return _react2.default.createElement(_FlatButton2.default, { style: flatButtonStyle, icon: _react2.default.createElement(NavigationChevronLeft, null), onClick: onClick });
	};

	var NextPageLink = function NextPageLink(_ref5) {
	  var isActive = _ref5.isActive;
	  var onClick = _ref5.onClick;
	  return _react2.default.createElement(_FlatButton2.default, { style: flatButtonStyle, icon: _react2.default.createElement(NavigationChevronRight, null), onClick: onClick });
	};

	var LastPageLink = function LastPageLink(_ref6) {
	  var isActive = _ref6.isActive;
	  var onClick = _ref6.onClick;
	  return _react2.default.createElement(_FlatButton2.default, { style: flatButtonStyle, icon: _react2.default.createElement(NavigationLastPage, null), onClick: onClick });
	};

	var itemTypeToComponent = (_itemTypeToComponent = {}, (0, _defineProperty3.default)(_itemTypeToComponent, ITEM_TYPES.PAGE, Page), (0, _defineProperty3.default)(_itemTypeToComponent, ITEM_TYPES.ELLIPSIS, Ellipsis), (0, _defineProperty3.default)(_itemTypeToComponent, ITEM_TYPES.FIRST_PAGE_LINK, FirstPageLink), (0, _defineProperty3.default)(_itemTypeToComponent, ITEM_TYPES.PREVIOS_PAGE_LINK, PreviousPageLink), (0, _defineProperty3.default)(_itemTypeToComponent, ITEM_TYPES.NEXT_PAGE_LINK, NextPageLink), (0, _defineProperty3.default)(_itemTypeToComponent, ITEM_TYPES.LAST_PAGE_LINK, LastPageLink), _itemTypeToComponent);

	var UltimatePaginationMaterialUi = createUltimatePagination({ itemTypeToComponent: itemTypeToComponent });
